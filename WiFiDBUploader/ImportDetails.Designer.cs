namespace WiFiDBUploader
{
    partial class ImportDetails
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label4.Text = "Use %DATETIME% in the Notes to have an AutoGenerated Date Time appended to it. (f" +
    "ormat is YYYY-MM-DD HH:MM:SS)";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Use %DATETIME% in the Title to have an AutoGenerated Date Time appended to it. (f" +
    "ormat is YYYY-MM-DD HH:MM:SS)";
            // 
            // ImportDetails
            // 
